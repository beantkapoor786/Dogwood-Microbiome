...
#We already have imported the otu file and taxonomy file from mothur to this R project/environment. We just need to import the metadata for leaves niche and subset the data accordingly.
